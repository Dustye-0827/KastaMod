...
namespace Kasta.NPCs.Bosses
{
	[AutoloadBossHead]
	internal class CaveDemolisherHead : CaveDemolisherWorm
	{
		public const string CaveDemolisherHeadHead = "Kasta/NPCs/Bosses/CaveDemolisherHead_Head_Boss";

        public override bool Autoload(ref string name)
        {
			mod.AddBossHeadTexture(CaveDemolisherHeadHead);
	...
	internal class CaveDemolisherBody : CaveDemolisherWorm
	{
		public override void SetDefaults()
		{
	...
	internal class CaveDemolisherTail : CaveDemolisherWorm
	{
		public override void SetDefaults()
		{
	...
	public abstract class CaveDemolisherWorm : Worm
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cave Demolisher");
		}
		...
		public override void Init()
		{
			minLength = 15;
			maxLength = 20;
			tailType = ModContent.NPCType<CaveDemolisherTail>();
			bodyType = ModContent.NPCType<CaveDemolisherBody>();
			headType = ModContent.NPCType<CaveDemolisherHead>();
			speed = 5.5f;
			turnSpeed = 0.045f;
		}
	}
